...
import { manrope } from '@/components/LandingPage/Hero';
    ...
    >
      <div className="relative z-10 flex h-min w-full flex-1 flex-shrink-0 flex-row flex-nowrap content-center items-center justify-between overflow-hidden">
        <div className="relative flex h-min w-full max-w-[600px] flex-1 flex-shrink-0 flex-col flex-nowrap content-start items-start justify-center gap-[40px] ">
          <h2
            className={`relative h-auto w-full flex-shrink-0 overflow-visible whitespace-pre-wrap break-words text-5xl leading-[1.2] ${staatliches.className} text-[#70e000]`}
          >
            Elevate Your Game with PlayPal
          </h2>
          <h3
            className={`${manrope.className} h-auto w-full flex-1 flex-shrink-0 overflow-visible whitespace-pre-wrap break-words text-xl leading-6 tracking-tight text-white`}
          >
